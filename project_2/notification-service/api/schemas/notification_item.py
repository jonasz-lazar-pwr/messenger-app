...
class SendNotificationIn(BaseModel):
    user_email: EmailStr = Field(..., description="Email address of the user who will receive the notification.")
...
class NotificationOut(BaseModel):
    ...
    user_email: EmailStr = Field(..., description="Email address of the user who received the notification.")
