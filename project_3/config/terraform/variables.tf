...
variable "cloud_map_namespace_name" {
  description = "Name of the Cloud Map namespace for service discovery (e.g., messenger-app.local)"
  type        = string
}
...
variable "iam_role_arn" {
  description = "ARN of the IAM role that grants all permissions."
  type        = string
}
...
variable "sqs_notification_queue_name" {
  description = "Name of the SQS queue used for notification-service"
  type        = string
}
